...
export const namesDatabase: Record<string, { meaning: string; onomastico: string }> = {
    ...
    giulia: {
        ...
        onomastico: "12 Aprile / 22 Maggio (Santa Giulia)"
    },
    emma: {
    ...
    greta: {
        meaning: "Diminutivo di Margherita, di origine greco-latina (margarites), significa 'perla'.",
        onomastico: "22 Luglio / 16 Novembre (Santa Margherita)"
    },
    chiara: {
